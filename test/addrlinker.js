...
contract('ClaimRegistry', function(accounts) {
  ...
  it("allows to link self as payment addresses", async function() {
    var subject = accounts[0];

    await claimRegistry.submitLinkage( subject, 0xe64befedd9baae8150524922635405db29d971749b267d4c0428ed952faa0d36, {from: subject}).catch(_ => threw = true);
